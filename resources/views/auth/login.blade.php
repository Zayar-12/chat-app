...
@section('title', 'Sign In - Chat App')
...
<div class="min-h-[calc(100vh-80px)] flex items-center justify-center bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            ...
            <h2 class="text-3xl font-black text-slate-900 uppercase tracking-tight">Welcome Back</h2>
            <p class="mt-2 text-sm text-slate-500 font-medium">Sign in to your account to start chatting with friends.</p>
        </div>
        ...
        <div class="bg-white p-8 sm:p-10 rounded-[2rem] shadow-xl shadow-slate-200/60 border border-slate-100">
            ...
            <div class="relative my-6 flex items-center justify-center">
                ...
                <span class="relative bg-white px-4 text-xs font-black text-slate-400 uppercase tracking-widest">Or login with</span>
            </div>
            ...
            <form class="space-y-5" action="{{ route('login') }}" method="POST">
                ...
                <div class="flex items-center justify-between px-1">
                    <div class="flex items-center">
                        ...
                        <label for="remember" class="ml-2 block text-sm text-slate-600 font-medium cursor-pointer selection:bg-transparent">Remember me</label>
                    </div>
                </div>
                ...
                <div class="pt-2">
                    <button type="submit" class="group relative w-full flex justify-center py-4 px-4 border border-transparent text-sm font-black rounded-xl text-white bg-slate-900 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 shadow-lg transition-all active:scale-[0.98]">
                        <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                            <svg class="h-5 w-5 text-slate-400 group-hover:text-blue-200 transition-colors" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
